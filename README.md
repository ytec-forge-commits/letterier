...
4. 写真・画像や文字箱は移動・拡縮・回転・透明度・前後関係・本文回り込みを調整できます。文字箱は本文と別に横書き・縦書きを選べます。写真や文字箱を用紙の上下端へドラッグし続けると画面が自動でスクロールし、別ページへそのまま移動できます。
...
本体コードは[Apache-2.0](LICENSE)。[第三者通知](THIRD_PARTY_NOTICES.md)、[素材](ASSETS_LICENSE.md)、[ブランド](BRAND_POLICY.md)、[適用範囲](LICENSE_EXCEPTIONS.md)、[プライバシー](PRIVACY.md)、[コード署名方針](CODE_SIGNING_POLICY.md)を参照してください。アプリ内からライセンス全文を閲覧できます。
