...
foreach ($part in @('scripts','public/legal','distribution','.local/cargo-target/release/bundle/nsis','src-tauri')) {
...
foreach ($name in @('README.md','README.en.md','LICENSE','NOTICE','THIRD_PARTY_NOTICES.md','ASSETS_LICENSE.md','BRAND_POLICY.md','LICENSE_EXCEPTIONS.md','PRIVACY.md','IMAGE-FORMATS.md','public/legal/LICENSE','distribution/README.md','.local/cargo-target/release/レタリエ.exe','.local/cargo-target/release/bundle/nsis/レタリエ_1.0.0_x64-setup.exe','.local/cargo-target/release/bundle/nsis/レタリエ_1.0.1_x64-setup.exe')) {
...
Write-Output 'PASS: only the requested version installer is included.'
